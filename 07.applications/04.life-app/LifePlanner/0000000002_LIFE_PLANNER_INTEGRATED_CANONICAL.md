...
purpose:
  - 人生全体の中長期計画を整理する
  - 5年/10年/20年の計画を可視化する
  - 家族、住居、仕事、学び、健康、老後、終活、法務の観点を横断する
  - 他アプリ情報を受けて人生設計の見直し候補を提示する
...
purpose:
  - LifePlanner の正本設計書群の入口
  - 各レイヤの読み順固定
  - LifeOS 人生設計領域の主軸アプリとしての位置づけ整理

read_order:
  - 0000001_LIFE_PLANNER_OVERVIEW.md
  - 0000002_LIFE_PLANNER_CANONICAL.md
...
documents:
  - 0100100000_CORE_INDEX.md
  - 0100100001_CORE_OVERVIEW.md
  - 0100100002_LIFE_PLANNER_CORE_PRINCIPLES.md
...
topics:
  - core principles
  - scope boundary
  - family collaboration principle
...
includes:
  - 0100001_LIFE_PLANNER_CONSTITUTION_OVERVIEW.md
...
subfolder: 010.application

documents:
  - 0200100000_APPLICATION_ARCHITECTURE_INDEX.md
  - 0200100001_APPLICATION_ARCHITECTURE_OVERVIEW.md
...
topics:
  - owner / family_viewer / family_editor
  - 計画管理
  - 年表管理
  - 目標管理
  - 見直し候補反映
...
core_scope:
  - LifePlanner の アーキテクチャ における中核設計を扱う
  - 他アプリ共通候補そのものではなく、本アプリ責務と接続前提を記述する
...
documents:
  - 0200000000_ARCHITECTURE_INDEX.md
  - 0200000001_ARCHITECTURE_OVERVIEW.md
...
includes:
  - 0200001_LIFE_PLANNER_ARCHITECTURE_OVERVIEW.md
...
subfolder: 010.domain

documents:
  - 0300100000_DOMAIN_MODEL_INDEX.md
  - 0300100001_DOMAIN_MODEL_OVERVIEW.md
...
documents:
  - 0300200000_LOGICAL_SCHEMA_INDEX.md
  - 0300200001_LOGICAL_SCHEMA_OVERVIEW.md
  - 0300200002_LIFE_PLANNER_LOGICAL_SCHEMA_POLICY.md
  - 0300200003_LIFE_PLANNER_LOGICAL_TABLE_LIFE_PLAN.md
  - 0300200004_LIFE_PLANNER_LOGICAL_TABLE_GOAL_AND_MILESTONE.md
...
purpose:
  - LifePlannerの保存先を life スキーマで固定する
  - 画面項目 exact 定義と保存構造を対応付ける
  - 実装前にテーブル責務とカラム責務を固定する
...
documents:
  - 0300300000_BINDING_INDEX.md
  - 0300300001_BINDING_OVERVIEW.md
...
documents:
  - 0300000000_MODEL_INDEX.md
  - 0300000001_MODEL_OVERVIEW.md
...
includes:
  - 0300001_LIFE_PLANNER_MODEL_OVERVIEW.md
...
summary:
  - 人生計画の基本エンティティを定義する
  - ライフイベント、目標、マイルストーン、見直し記録の関係を固定する
  - 家族共有は閲覧中心で扱う
...
documents:
  - 0300400000_MASTER_DEFINITION_INDEX.md
  - 0300400001_MASTER_DEFINITION_OVERVIEW.md
  - 0300400002_LIFE_PLANNER_CATEGORY_MASTER.md
  - 0300400003_LIFE_PLANNER_ENUM_MASTER.md
...
documents:
  - 0300500000_DERIVED_DEFINITION_INDEX.md
  - 0300500001_DERIVED_DEFINITION_OVERVIEW.md
  - 0300500002_LIFE_PLANNER_DERIVED_METRIC_CATALOG.md
  - 0300500003_LIFE_PLANNER_HOME_AND_PLAN_SUMMARY_DERIVED_RULES.md
...
core_scope:
  - LifePlanner の ランタイム における中核設計を扱う
  - 他アプリ共通候補そのものではなく、本アプリ責務と接続前提を記述する
...
subfolder: 010.lifecycle

documents:
  - 0400100000_LIFECYCLE_INDEX.md
  - 0400100001_LIFECYCLE_OVERVIEW.md
...
documents:
  - 0400200000_STATE_MACHINE_INDEX.md
  - 0400200001_STATE_MACHINE_OVERVIEW.md
  - 0400200002_LIFE_PLANNER_PLAN_STATE_MACHINE.md
  - 0400200003_LIFE_PLANNER_GOAL_AND_MILESTONE_STATE_MACHINE.md
  - 0400200004_LIFE_PLANNER_TIMELINE_AND_REVIEW_STATE_MACHINE.md
...
documents:
  - 0400300000_COLLABORATION_RUNTIME_INDEX.md
  - 0400300001_COLLABORATION_RUNTIME_OVERVIEW.md
  - 0400300002_LIFE_PLANNER_SHARED_EDIT_RUNTIME_POLICY.md
  - 0400300003_LIFE_PLANNER_OWNER_CONFIRMATION_RUNTIME.md
...
purpose:
  - Family共有時の共同編集挙動を設計する
  - owner / family_editor / family_viewer の変更反映ルールを整理する
  - 編集衝突や owner確認が必要な場面を明確にする

runtime_principles:
  - owner is final decision maker
  - family_editor can help edit within scope
  - family_viewer is read-only
  - no silent override for major changes
...
documents:
  - 0400000000_RUNTIME_INDEX.md
  - 0400000001_RUNTIME_OVERVIEW.md
...
includes:
  - 0400001_LIFE_PLANNER_RUNTIME_OVERVIEW.md
...
documents:
  - 0500100000_USER_FLOW_INDEX.md
  - 0500100001_USER_FLOW_OVERVIEW.md
...
documents:
  - 0500000000_FLOW_INDEX.md
  - 0500000001_FLOW_OVERVIEW.md
...
includes:
  - 0500001_LIFE_PLANNER_FLOW_OVERVIEW.md
...
subfolder: 010.lifeos-link

documents:
  - 0600100000_LIFEOS_LINK_INDEX.md
  - 0600100001_LIFEOS_LINK_OVERVIEW.md
...
topics:
  - inbound from MoneyPlanner
  - inbound from EndOfLifePlanner
  - inbound from health apps
...
documents:
  - 0600200000_PAYLOAD_INDEX.md
  - 0600200001_PAYLOAD_OVERVIEW.md
  - 0600200002_LIFE_PLANNER_PAYLOAD_COMMON_RULES.md
  - 0600200003_LIFE_PLANNER_PLAN_REQUEST_RESPONSE_EXACT.md
  - 0600200004_LIFE_PLANNER_GOAL_REQUEST_RESPONSE_EXACT.md
...
documents:
  - 0600300000_CONTRACT_BINDING_INDEX.md
  - 0600300001_CONTRACT_BINDING_OVERVIEW.md
...
purpose:
  - payload と論理テーブルの対応を固定する
  - どの operation がどの entity を読むか / 書くかを明確化する
  - 実装前に副作用範囲を固定する

policy:
  - list/detail/compare の多くは read 中心
  - create/update/apply/invite は write を伴う
...
documents:
  - 0600400000_CONNECTED_APP_ASSUMPTION_INDEX.md
  - 0600400001_CONNECTED_APP_ASSUMPTION_OVERVIEW.md
...
documents:
  - 0600000000_INTEGRATION_INDEX.md
  - 0600000001_INTEGRATION_OVERVIEW.md
...
includes:
  - 0600001_LIFE_PLANNER_INTEGRATION_OVERVIEW.md
...
summary:
  ...
  - MoneyPlanner / EndOfLifePlanner / 健康系アプリとの線引きを固定する
  - 自動送信禁止を明確化する
...
subfolder: 010.plan-ops

documents:
  - 0700100000_PLAN_OPS_INDEX.md
  - 0700100001_PLAN_OPS_OVERVIEW.md
...
documents:
  - 0700200000_NOTIFICATION_REVIEW_INDEX.md
  - 0700200001_NOTIFICATION_REVIEW_OVERVIEW.md
  - 0700200002_LIFE_PLANNER_NOTIFICATION_POLICY.md
  - 0700200003_LIFE_PLANNER_REVIEW_CYCLE_POLICY.md
...
documents:
  - 0700300000_DATA_LIFECYCLE_INDEX.md
  - 0700300001_DATA_LIFECYCLE_OVERVIEW.md
  - 0700300002_LIFE_PLANNER_PLAN_LIFECYCLE_POLICY.md
  - 0700300003_LIFE_PLANNER_SHARED_MEMBER_LIFECYCLE_POLICY.md
...
purpose:
  - LifePlannerのデータがどう作られ、運用され、整理されるかを定義する
  - 長期利用を前提に、放置・整理・終了時の扱いを明確にする
  - archive / restore / delete の意味を混同しない

principles:
  - delete より archive を基本優先にする
  - long-term planning data is valuable and should not disappear casually
...
documents:
  - 0700400000_CHECKLIST_RISK_VALUE_INDEX.md
  - 0700400001_CHECKLIST_RISK_VALUE_OVERVIEW.md
  - 0700400002_LIFE_PLANNER_FUTURE_CHECKLIST_OPERATION_POLICY.md
  - 0700400003_LIFE_PLANNER_RISK_LIST_OPERATION_POLICY.md
...
purpose:
  - 将来チェックリスト、リスク一覧、価値観整理ワークの運用意味を定義する
  - これらを単なる補助UIではなく、計画見直し支援の一部として位置づける
  - 長期計画に必要な「抜け漏れ防止」「不確実性整理」「優先基準整理」を扱う

principles:
  - checklist は不安を煽るためではなく抜け漏れ確認のために使う
  - risk list は悲観表ではなく備えの整理表として扱う
...
value_work_purpose:
  - 何を優先して人生設計するかを整理する
  - goal の優先順位や scenario 比較の判断軸を明確にする

value_themes_examples:
  - family_stability
  - flexibility
  - growth
  - health_first
...
operation_rules:
  - value work は答えを固定するものではない
  - annual review や major transition 時に見直せる
  - scenario compare で reference axis として使える
...
documents:
  - 0700500000_RECOMMENDATION_RULES_INDEX.md
  - 0700500001_RECOMMENDATION_RULES_OVERVIEW.md
  - 0700500002_LIFE_PLANNER_REVIEW_NEEDED_RULES.md
  - 0700500003_LIFE_PLANNER_HOME_RECOMMENDATION_PRIORITY_RULES.md
...
documents:
  - 0700000000_OPERATIONS_INDEX.md
  - 0700000001_OPERATIONS_OVERVIEW.md
...
includes:
  - 0700001_LIFE_PLANNER_OPERATIONS_OVERVIEW.md
...
core_scope:
  - LifePlanner の ポリシー における中核設計を扱う
  - 他アプリ共通候補そのものではなく、本アプリ責務と接続前提を記述する
...
subfolder: 010.privacy-pricing

documents:
  - 0800100000_PRIVACY_PRICING_INDEX.md
  - 0800100001_PRIVACY_PRICING_OVERVIEW.md
...
documents:
  - 0800200000_VALIDATION_RULES_INDEX.md
  - 0800200001_VALIDATION_RULES_OVERVIEW.md
  - 0800200002_LIFE_PLANNER_PLAN_AND_GOAL_VALIDATION_RULES.md
  - 0800200003_LIFE_PLANNER_TIMELINE_AND_REVIEW_VALIDATION_RULES.md
  - 0800200004_LIFE_PLANNER_SHARE_SCENARIO_REFLECTION_VALIDATION_RULES.md
...
documents:
  - 0800300000_AI_ASSIST_INDEX.md
  - 0800300001_AI_ASSIST_OVERVIEW.md
  - 0800300002_LIFE_PLANNER_AI_ASSIST_SCOPE_POLICY.md
  - 0800300003_LIFE_PLANNER_AI_ASSIST_INTERACTION_PATTERNS.md
...
purpose:
  - AI整理支援の役割を固定する
  - 何を提案できて何を自動決定しないかを明確にする
  - 画面や通知と矛盾しない対話支援の前提を置く

ai_principles:
  - AIは整理支援役であり最終決定者ではない
  - 人生設計を分かりやすく言い換え、比較観点を出す
  - 不安を煽らない
  - 法律、医療、投資の最終判断を代行しない
...
documents:
  - 0800400000_COPY_POLICY_INDEX.md
  - 0800400001_COPY_POLICY_OVERVIEW.md
  - 0800400002_LIFE_PLANNER_COPY_TONE_POLICY.md
...
purpose:
  - LifePlanner全体の文言トーンを固定する
  - センシティブ領域でも違和感の少ない表現を保つ
...
tone_rules:
  ...
  - calm not alarming
  - respectful for sensitive topics
...
documents:
  - 0800600000_CONFLICT_CHANGE_CONTROL_INDEX.md
  - 0800600001_CONFLICT_CHANGE_CONTROL_OVERVIEW.md
  - 0800600002_LIFE_PLANNER_CONFLICT_POLICY.md
  - 0800600003_LIFE_PLANNER_CHANGE_PROPOSAL_POLICY.md
...
purpose:
  - 共同編集時の競合ルールを policy として固定する
  - change proposal と direct edit を分けて扱う
  - 長期計画にふさわしい履歴意識を持たせる

principles:
  - avoid silent overwrite
  - preserve clear accountability
  - make owner authority explicit but not obstructive
...
documents:
  - 0800700000_SETTINGS_DEFAULTS_INDEX.md
  - 0800700001_SETTINGS_DEFAULTS_OVERVIEW.md
  - 0800700002_LIFE_PLANNER_NOTIFICATION_DEFAULT_POLICY.md
  - 0800700003_LIFE_PLANNER_DISPLAY_DEFAULT_POLICY.md
...
purpose:
  - 設定画面で扱う主要既定値を定義する
  - notification, display, review assist の初期値を揃える
  - 初回利用時の迷いを減らす

policy:
  - defaults should be helpful but not intrusive
  - users can later reduce noise
...
documents:
  - 0800000000_POLICY_INDEX.md
  - 0800000001_POLICY_OVERVIEW.md
...
includes:
  - 0800001_LIFE_PLANNER_POLICY_OVERVIEW.md
...
summary:
  - 人生判断非代替、共有制御、関連アプリ連携のポリシーを定義する
  - AI 利用時の制限を固定する
  - 本人意思尊重を軸にした倫理境界を持つ
...
core_scope:
  - LifePlanner の インターフェース における中核設計を扱う
  - 他アプリ共通候補そのものではなく、本アプリ責務と接続前提を記述する
...
documents:
  - 0900100000_SCREEN_INDEX.md
  - 0900100001_SCREEN_OVERVIEW.md
...
documents:
  - 0900200000_SCREEN_ITEM_INDEX.md
  - 0900200001_SCREEN_ITEM_OVERVIEW.md
  - 0900200002_LIFE_PLANNER_SCREEN_ITEM_COMMON_RULES.md
  - 0900200003_LIFE_PLANNER_HOME_SCREEN_ITEM_EXACT.md
  - 0900200004_LIFE_PLANNER_PLAN_DETAIL_SCREEN_ITEM_EXACT.md
  ...
  - 0900200008_LIFE_PLANNER_REFLECTION_CANDIDATE_SCREEN_ITEM_EXACT.md
...
documents:
  - 0900300000_ACCESS_CONTROL_INDEX.md
  - 0900300001_ACCESS_CONTROL_OVERVIEW.md
...
documents:
  - 0900400000_DASHBOARD_DISPLAY_INDEX.md
  - 0900400001_DASHBOARD_DISPLAY_OVERVIEW.md
  - 0900400002_LIFE_PLANNER_HOME_DASHBOARD_EXACT.md
  - 0900400003_LIFE_PLANNER_DOMAIN_DASHBOARD_EXACT.md
...
purpose:
  - ダッシュボードに何を出すかを exact に定義する
  - summary / derived / alert の責務を分ける
  - mobile と larger screen の見せ方差を整理する
...
documents:
  - 0900500000_ONBOARDING_TEMPLATE_INDEX.md
  - 0900500001_ONBOARDING_TEMPLATE_OVERVIEW.md
  - 0900500002_LIFE_PLANNER_FIRST_RUN_FLOW.md
  - 0900500003_LIFE_PLANNER_INITIAL_SETUP_WIZARD_ITEMS.md
...
documents:
  - 0900600000_SEARCH_FILTER_INDEX.md
  - 0900600001_SEARCH_FILTER_OVERVIEW.md
  - 0900600002_LIFE_PLANNER_PLAN_SEARCH_FILTER_SORT.md
  - 0900600003_LIFE_PLANNER_GOAL_SEARCH_FILTER_SORT.md
...
documents:
  - 0900700000_EXPORT_SUMMARY_INDEX.md
  - 0900700001_EXPORT_SUMMARY_OVERVIEW.md
  - 0900700002_LIFE_PLANNER_SUMMARY_VIEW_DESIGN.md
  - 0900700003_LIFE_PLANNER_PRINT_AND_SHARE_VIEW_POLICY.md
...
purpose:
  - 人生計画を他者と見やすく共有するための要約ビューを設計する
  - 印刷や共有前提の見せ方を整理する
  - 実際のファイル出力実装前に、どの情報をどの粒度で見せるかを決める

principles:
  - まずは「見せる内容」の設計を固定する
  - センシティブカテゴリは share scope を守る
...
documents:
  - 0900800000_COPY_STATE_INDEX.md
  - 0900800001_COPY_STATE_OVERVIEW.md
  - 0900800002_LIFE_PLANNER_EMPTY_STATE_COPY.md
  - 0900800003_LIFE_PLANNER_ERROR_STATE_COPY.md
  - 0900800004_LIFE_PLANNER_SUCCESS_STATE_COPY.md
  - 0900800005_LIFE_PLANNER_UPGRADE_AND_GUIDE_COPY.md
...
documents:
  - 0900900000_ARCHIVE_DELETE_INDEX.md
  - 0900900001_ARCHIVE_DELETE_OVERVIEW.md
  - 0900900002_LIFE_PLANNER_ARCHIVE_DELETE_UI_FLOW.md
  - 0900900003_LIFE_PLANNER_RESTORE_UI_FLOW.md
...
documents:
  - 0900000000_INTERFACE_INDEX.md
  - 0900000001_INTERFACE_OVERVIEW.md
...
includes:
  - 0900001_LIFE_PLANNER_INTERFACE_OVERVIEW.md
...
documents:
  - 0901000000_CHANGE_REVIEW_INDEX.md
  - 0901000001_CHANGE_REVIEW_OVERVIEW.md
  - 0901000002_LIFE_PLANNER_CONFLICT_REVIEW_UI.md
  - 0901000003_LIFE_PLANNER_OWNER_REVIEW_QUEUE_UI.md
...
documents:
  - 0901100000_SETTINGS_WORKBOOK_INDEX.md
  - 0901100001_SETTINGS_WORKBOOK_OVERVIEW.md
  - 0901100002_LIFE_PLANNER_SETTINGS_SCREEN_EXACT.md
  - 0901100003_LIFE_PLANNER_CHECKLIST_RISK_VALUE_SCREEN_EXACT.md
...
purpose:
  - settings screen と workbook-like support screens の exact 設計を置く
  - checklist / risk / value work を散らさず整理する
  - 主要設定と補助ワークの入口を分かりやすくする
...
copy_examples:
  ...
  future_checklist_title:
    - 将来チェックリスト

  future_checklist_body:
    - 抜け漏れがないか、気軽に確認できます。必要なら目標や予定にも変えられます。

  risk_list_title:
    - リスク一覧

  risk_list_body:
    - 不安を書き出すためではなく、備えを整理するための一覧です。

  value_work_title:
    - 価値観整理ワーク

  value_work_body:
    - 何を優先したいかを整理すると、目標や比較判断が決めやすくなります。
...
documents:
  - 0901200000_INDICATOR_SCORE_INDEX.md
  - 0901200001_INDICATOR_SCORE_OVERVIEW.md
  - 0901200002_LIFE_PLANNER_BADGE_AND_INDICATOR_DESIGN.md
  - 0901200003_LIFE_PLANNER_REVIEW_AND_PROGRESS_SCORE_DISPLAY.md
...
purpose:
  - バッジや注意表示、進捗表示の設計を固定する
  - score 的な見せ方を使う場合の抑制ルールを定義する
  - 見やすくしても、過度な断定や煽りにしない

principles:
  - indicator should support orientation, not judgement
...
core_scope:
  - LifePlanner の セキュリティ における中核設計を扱う
  - 他アプリ共通候補そのものではなく、本アプリ責務と接続前提を記述する
...
subfolder: 010.data-protection

documents:
  - 1000100000_DATA_PROTECTION_INDEX.md
  - 1000100001_DATA_PROTECTION_OVERVIEW.md
...
documents:
  - 1000000000_SECURITY_INDEX.md
  - 1000000001_SECURITY_OVERVIEW.md
...
includes:
  - 1000001_LIFE_PLANNER_SECURITY_OVERVIEW.md
...
core_scope:
  - LifePlanner の インフラ における中核設計を扱う
  - 他アプリ共通候補そのものではなく、本アプリ責務と接続前提を記述する
...
subfolder: 010.device-platform

documents:
  - 1100100000_DEVICE_PLATFORM_INDEX.md
  - 1100100001_DEVICE_PLATFORM_OVERVIEW.md
...
documents:
  - 1100200000_LOCALIZATION_DEVICE_INDEX.md
  - 1100200001_LOCALIZATION_DEVICE_OVERVIEW.md
  - 1100200002_LIFE_PLANNER_MULTILINGUAL_POLICY.md
  - 1100200003_LIFE_PLANNER_MULTICURRENCY_POLICY.md
...
documents:
  - 1100000000_INFRASTRUCTURE_INDEX.md
  - 1100000001_INFRASTRUCTURE_OVERVIEW.md
...
includes:
  - 1100001_LIFE_PLANNER_INFRASTRUCTURE_OVERVIEW.md
...
subfolder: 010.release-plan

documents:
  - 1200100000_RELEASE_PLAN_INDEX.md
  - 1200100001_RELEASE_PLAN_OVERVIEW.md
...
documents:
  - 1200200000_SCOPE_MATRIX_INDEX.md
  - 1200200001_SCOPE_MATRIX_OVERVIEW.md
...
documents:
  - 1200300000_READINESS_GATE_INDEX.md
  - 1200300001_READINESS_GATE_OVERVIEW.md
...
documents:
  - 1200400000_ACCEPTANCE_CRITERIA_INDEX.md
  - 1200400001_ACCEPTANCE_CRITERIA_OVERVIEW.md
  - 1200400002_LIFE_PLANNER_CORE_SCENARIO_ACCEPTANCE_CRITERIA.md
  - 1200400003_LIFE_PLANNER_ROLE_AND_PLAN_ACCEPTANCE_CRITERIA.md
...
purpose:
  - 実装前にどこまで設計が揃っているかを整理する
  - いま着手してはいけない領域を明示する
  - 実装開始時の最初のスコープを迷わないようにする

package_meaning:
  - this is not implementation kickoff
...
later_scope_examples:
  - deeper template library
  - richer family meeting package
  - advanced proposal workflow
  - full activity timeline sophistication
  - smarter recommendation heuristics
  - richer print/export variants
  - scenario compare refinement
  - dedupe policy refinement for reflection candidates

policy:
  - these are not blockers for first implementation wave
...
documents:
  - 1200000000_IMPLEMENTATION_INDEX.md
  - 1200000001_IMPLEMENTATION_OVERVIEW.md
...
includes:
  - 1200001_LIFE_PLANNER_IMPLEMENTATION_OVERVIEW.md
...
subfolder: 010.backlog

documents:
  - 1300100000_BACKLOG_INDEX.md
  - 1300100001_BACKLOG_OVERVIEW.md
...
system: LifePlanner
layer: 130.development
subfolder: 030.decision-log
owner: Boss
prepared_by: Zero
schema: life

documents:
  - 1300300000_DECISION_LOG_INDEX.md
  - 1300300001_DECISION_LOG_OVERVIEW.md
...
fixed_decisions:
  - decision_id: LP-DEC-001
    topic: storage schema
    decision:
      - persistence schema is life

  - decision_id: LP-DEC-002
    topic: implementation timing
    decision:
      - implementation is not started yet
      - design only at current stage

  - decision_id: LP-DEC-003
    topic: app positioning
    decision:
      - LifePlanner is the main long-term life planning app in LifeOS

  - decision_id: LP-DEC-004
    topic: pricing
    decision:
      - Free 0 yen
      - Family 500 yen
  ...
  - decision_id: LP-DEC-005
    topic: family collaboration
    decision:
      - owner / family_viewer / family_editor role model is adopted

  - decision_id: LP-DEC-006
    topic: reflection policy
    decision:
      - external app signals become reflection candidates
      - no automatic final apply

  - decision_id: LP-DEC-007
    topic: design progression
    decision:
      - outputs should be bundled as much as possible in later steps

  - decision_id: LP-DEC-008
    topic: common components
    decision:
      - common component formalization is handled in another chat later

  - decision_id: LP-DEC-009
    topic: multi environment support
    decision:
      - iphone / android / pc / tablet are all in scope

  - decision_id: LP-DEC-010
    topic: non-functional display
    decision:
...
documents:
  - 1300400000_OPEN_ISSUES_INDEX.md
  - 1300400001_OPEN_ISSUES_OVERVIEW.md
...
documents:
  - 1300500000_DESIGN_AUDIT_INDEX.md
  - 1300500001_DESIGN_AUDIT_OVERVIEW.md
...
documents:
  - 1300600000_TRACEABILITY_INDEX.md
  - 1300600001_TRACEABILITY_OVERVIEW.md
  - 1300600002_LIFE_PLANNER_REQUIREMENT_TO_DOCUMENT_MATRIX.md
...
documents:
  - 1300700000_EDGE_CASES_INDEX.md
  - 1300700001_EDGE_CASES_OVERVIEW.md
  - 1300700002_LIFE_PLANNER_PERMISSION_EDGE_CASES.md
  - 1300700003_LIFE_PLANNER_DATE_CURRENCY_EDGE_CASES.md
...
documents:
  - 1300800000_FINAL_HANDOFF_INDEX.md
  - 1300800001_FINAL_HANDOFF_OVERVIEW.md
  - 1300800002_LIFE_PLANNER_DESIGN_COMPLETION_SUMMARY.md
...
purpose:
  - 今チャットで積み上げた設計を最後に要約する
  - block / non-block / next-chat transfer を整理する
...
blocking_before_real_implementation:
  - category master final review
  - cross-document contradiction audit
  - upstream connected-app assumption confirmation
  - final review of Family-only boundaries
  - final review of sensitive visibility rules

non_blocking_or_later:
  - deep template expansion
  - export file format specifics
  - advanced proposal workflow
  - reflection candidate dedupe sophistication
  - advanced analytics-like indicators

guidance:
  - block only on contradictions or core boundary uncertainty
...
documents:
  - 1300900000_CLOSE_PACKAGE_INDEX.md
  - 1300900001_CLOSE_PACKAGE_OVERVIEW.md
  - 1300900002_LIFE_PLANNER_FINAL_CLOSE_PACKAGE.md
  - 1300900003_LIFE_PLANNER_DOCUMENT_COVERAGE_LEDGER.md
  - 1300900004_LIFE_PLANNER_FREEZE_RECOMMENDATION_NOTE.md
...
purpose:
  - LifePlanner 設計を閉じるための最終まとめを置く
  - どこまで決まっているかを短く把握できるようにする
...
documents:
  - 1300000000_DEVELOPMENT_INDEX.md
  - 1300000001_DEVELOPMENT_OVERVIEW.md
...
includes:
  - 1300001_LIFE_PLANNER_DEVELOPMENT_OVERVIEW.md
