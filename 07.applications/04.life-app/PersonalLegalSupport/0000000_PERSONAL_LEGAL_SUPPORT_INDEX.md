...
purpose:
  - PersonalLegalSupport の正本設計書群の入口
  - 各レイヤの読み順固定
  - LifeOS 法律領域アプリとしての設計位置づけ整理

read_order:
  - 0000001_PERSONAL_LEGAL_SUPPORT_OVERVIEW.md
  - 0000002_PERSONAL_LEGAL_SUPPORT_CANONICAL.md
