-- ============================================================
-- AICompanyManager 90 Rollback Refined Candidate
...
drop function if exists business.aicm_start_workflow_local_stub(uuid, uuid, uuid, jsonb);
drop function if exists business.aicm_apply_review_action(uuid, text, text, text);
drop function if exists business.aicm_create_company_with_owner(text, text);
...
-- pgcrypto is not dropped by rollback candidate.
