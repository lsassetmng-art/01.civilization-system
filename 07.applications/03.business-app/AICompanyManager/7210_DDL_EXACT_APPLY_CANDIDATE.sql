-- ============================================================
-- AICompanyManager DDL Exact Apply Candidate
...
create table if not exists business.aicm_company_common_rule_file (
  rule_file_id uuid primary key default gen_random_uuid(),
  company_id uuid not null references business.aicm_company(company_id) on delete cascade,
  file_name text not null,
  file_role text not null default 'company_common_rule'
    check (file_role in ('company_common_rule')),
