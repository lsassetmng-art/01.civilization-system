-- ============================================================
-- AICompanyManager DB/RLS Integrated Review Bundle
-- Phase BA-BD
-- reviewer: 佐藤（DB担当）
-- db_apply: false
-- rls_apply: false
...
-- This file is a review bundle only.
-- It concatenates DDL refined draft and RLS policy draft for review.
-- Do not paste into psql.
-- Do not execute as migration.

-- ============================================================
-- Part 1: DDL refined draft
-- ============================================================
...
-- ============================================================
-- Phase AY review notes appended
-- reviewer: 佐藤（DB担当）
-- db_apply: false
-- DO NOT EXECUTE WITHOUT BOSS DB OK
-- ============================================================
...
-- Review note 1:
-- aiworker_robot_id is intentionally logical reference only.
-- Physical FK to AIWorkerOS canon is deferred until cross-schema ownership is fixed.

-- Review note 2:
-- company_id is duplicated into child tables intentionally for query/RLS boundary.
-- Cross-company consistency between company_id/department_id/organization_id
-- should be enforced later by trigger or composite FK design after DB review.

-- Review note 3:
-- updated_at trigger is not included in this draft.
-- Add common updated_at trigger in a later migration phase if approved.

-- Review note 4:
-- RLS is intentionally not included in this DDL.
-- RLS policy design must be separated into a later Phase.

-- Review note 5:
-- This DDL is additive draft only.
-- Do not execute until Boss explicitly says DB OK.

-- ============================================================
-- Part 2: RLS policy draft
-- ============================================================
