...
drop policy if exists p_shift_pdf_export_history_select on app_shift_manager.shift_pdf_export_history;
create policy p_shift_pdf_export_history_select
on app_shift_manager.shift_pdf_export_history
for select
using (
  exported_by_person_id = app_shift_manager.fn_current_person_id()
