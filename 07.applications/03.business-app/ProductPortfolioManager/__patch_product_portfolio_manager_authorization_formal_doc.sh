...
cat <<'EOF' > "$BASE/100.security/1000002_PRODUCT_PORTFOLIO_MANAGER_AUTHORIZATION_FORMAL_DESIGN.md"
# ============================================================
...
cat <<'EOF' > "$BASE/080.policy/0800003_PRODUCT_PORTFOLIO_MANAGER_ROLE_AND_APPROVAL_POLICY.md"
# ============================================================
...
echo "PATCHED: authorization formal design docs added"
echo "BASE=$BASE"
echo
