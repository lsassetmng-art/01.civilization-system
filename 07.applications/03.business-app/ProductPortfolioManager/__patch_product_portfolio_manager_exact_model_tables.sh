...
mkdir -p "$BASE/030.model"

cat <<'EOF' > "$BASE/030.model/0300007_PRODUCT_PORTFOLIO_MANAGER_EXACT_TABLES_AND_ENUMS.md"
# ============================================================
...
cat <<'EOF' > "$BASE/030.model/0300008_PRODUCT_PORTFOLIO_MANAGER_ENTITY_RELATION_MATRIX.md"
# ============================================================
...
cat <<'EOF' > "$BASE/030.model/0300009_PRODUCT_PORTFOLIO_MANAGER_MODEL_TO_API_MAPPING.md"
# ============================================================
...
echo "PATCHED: exact model tables and enums added"
echo "BASE=$BASE"
echo
