...
mkdir -p "$BASE/050.flow"

cat <<'EOF' > "$BASE/050.flow/0500007_PRODUCT_PORTFOLIO_MANAGER_BUSINESS_FLOW_FORMAL_DESIGN.md"
# ============================================================
...
echo "PATCHED: business flow formal design doc added"
echo "BASE=$BASE"
echo
