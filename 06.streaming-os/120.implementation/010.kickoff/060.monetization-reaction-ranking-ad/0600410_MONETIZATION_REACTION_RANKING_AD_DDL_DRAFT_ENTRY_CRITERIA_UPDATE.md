# ============================================================
# MONETIZATION REACTION RANKING AD DDL DRAFT ENTRY CRITERIA UPDATE
# ============================================================
...
entry_criteria_for_k6_ddl_draft_review:
...
- creator-safe/public-safe/viewer-safe/runtime-only strategy is narrowed to approval-candidate state
