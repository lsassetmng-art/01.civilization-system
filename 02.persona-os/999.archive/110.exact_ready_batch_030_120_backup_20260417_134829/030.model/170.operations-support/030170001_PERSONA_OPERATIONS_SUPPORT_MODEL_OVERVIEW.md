...
system: PersonaOS
layer: model
domain_hint: 170.operations-support
canonical: candidate
...
for the 170.operations-support model area of PersonaOS.

model_role:
The 170.operations-support model set exists to define what must be stored, versioned,
