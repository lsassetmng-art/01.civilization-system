...
system: PersonaOS
layer: model
domain_hint: 035_PERSONA_APPLY_LOG_MODEL.md
canonical: candidate
...
for the 035_PERSONA_APPLY_LOG_MODEL.md model area of PersonaOS.

model_role:
The 035_PERSONA_APPLY_LOG_MODEL.md model set exists to define what must be stored, versioned,
