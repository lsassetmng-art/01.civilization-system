...
system: PersonaOS
layer: model
domain_hint: 033_PERSONA_STATE_MODEL.md
canonical: candidate
...
for the 033_PERSONA_STATE_MODEL.md model area of PersonaOS.

model_role:
The 033_PERSONA_STATE_MODEL.md model set exists to define what must be stored, versioned,
