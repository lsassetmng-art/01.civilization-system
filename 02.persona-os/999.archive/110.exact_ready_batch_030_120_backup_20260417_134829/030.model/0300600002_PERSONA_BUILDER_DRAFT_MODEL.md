...
system: PersonaOS
layer: model
domain_hint: 0300600002_PERSONA_BUILDER_DRAFT_MODEL.md
canonical: candidate
...
for the 0300600002_PERSONA_BUILDER_DRAFT_MODEL.md model area of PersonaOS.

model_role:
The 0300600002_PERSONA_BUILDER_DRAFT_MODEL.md model set exists to define what must be stored, versioned,
