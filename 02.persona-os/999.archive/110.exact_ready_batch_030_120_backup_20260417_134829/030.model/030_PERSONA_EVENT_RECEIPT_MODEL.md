...
system: PersonaOS
layer: model
domain_hint: 030_PERSONA_EVENT_RECEIPT_MODEL.md
canonical: candidate
...
for the 030_PERSONA_EVENT_RECEIPT_MODEL.md model area of PersonaOS.

model_role:
The 030_PERSONA_EVENT_RECEIPT_MODEL.md model set exists to define what must be stored, versioned,
