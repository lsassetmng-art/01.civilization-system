...
system: PersonaOS
layer: model
domain_hint: 032_PERSONA_GROWTH_MODEL.md
canonical: candidate
...
for the 032_PERSONA_GROWTH_MODEL.md model area of PersonaOS.

model_role:
The 032_PERSONA_GROWTH_MODEL.md model set exists to define what must be stored, versioned,
