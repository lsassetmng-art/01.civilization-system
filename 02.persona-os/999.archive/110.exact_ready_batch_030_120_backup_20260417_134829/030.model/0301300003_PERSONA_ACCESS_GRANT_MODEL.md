...
system: PersonaOS
layer: model
domain_hint: 0301300003_PERSONA_ACCESS_GRANT_MODEL.md
canonical: candidate
...
for the 0301300003_PERSONA_ACCESS_GRANT_MODEL.md model area of PersonaOS.

model_role:
The 0301300003_PERSONA_ACCESS_GRANT_MODEL.md model set exists to define what must be stored, versioned,
