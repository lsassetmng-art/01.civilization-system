...
system: PersonaOS
layer: model
domain_hint: 039_PERSONA_EXTERNAL_APPLY_AUDIT_MODEL.md
canonical: candidate
...
for the 039_PERSONA_EXTERNAL_APPLY_AUDIT_MODEL.md model area of PersonaOS.

model_role:
The 039_PERSONA_EXTERNAL_APPLY_AUDIT_MODEL.md model set exists to define what must be stored, versioned,
