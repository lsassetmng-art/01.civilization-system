...
system: PersonaOS
layer: model
domain_hint: 036_PERSONA_IDEMPOTENCY_RECORD_MODEL.md
canonical: candidate
...
for the 036_PERSONA_IDEMPOTENCY_RECORD_MODEL.md model area of PersonaOS.

model_role:
The 036_PERSONA_IDEMPOTENCY_RECORD_MODEL.md model set exists to define what must be stored, versioned,
