...
system: PersonaOS
layer: model
domain_hint: 030_PERSONA-OS_MODEL_OVERVIEW.md
canonical: candidate
...
for the 030_PERSONA-OS_MODEL_OVERVIEW.md model area of PersonaOS.

model_role:
The 030_PERSONA-OS_MODEL_OVERVIEW.md model set exists to define what must be stored, versioned,
