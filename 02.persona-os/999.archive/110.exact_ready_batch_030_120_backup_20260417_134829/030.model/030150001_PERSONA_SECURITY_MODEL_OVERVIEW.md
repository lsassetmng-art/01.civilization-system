...
system: PersonaOS
layer: model
domain_hint: 030150001_PERSONA_SECURITY_MODEL_OVERVIEW.md
canonical: candidate
...
for the 030150001_PERSONA_SECURITY_MODEL_OVERVIEW.md model area of PersonaOS.

model_role:
The 030150001_PERSONA_SECURITY_MODEL_OVERVIEW.md model set exists to define what must be stored, versioned,
