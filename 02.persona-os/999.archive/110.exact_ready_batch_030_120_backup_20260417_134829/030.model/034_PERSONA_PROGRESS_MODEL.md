...
system: PersonaOS
layer: model
domain_hint: 034_PERSONA_PROGRESS_MODEL.md
canonical: candidate
...
for the 034_PERSONA_PROGRESS_MODEL.md model area of PersonaOS.

model_role:
The 034_PERSONA_PROGRESS_MODEL.md model set exists to define what must be stored, versioned,
