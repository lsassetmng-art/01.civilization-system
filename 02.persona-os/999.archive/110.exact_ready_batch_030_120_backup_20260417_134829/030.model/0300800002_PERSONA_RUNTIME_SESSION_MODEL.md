...
system: PersonaOS
layer: model
domain_hint: 0300800002_PERSONA_RUNTIME_SESSION_MODEL.md
canonical: candidate
...
for the 0300800002_PERSONA_RUNTIME_SESSION_MODEL.md model area of PersonaOS.

model_role:
The 0300800002_PERSONA_RUNTIME_SESSION_MODEL.md model set exists to define what must be stored, versioned,
