...
system: PersonaOS
layer: model
domain_hint: 037_PERSONA_REJECT_RECORD_MODEL.md
canonical: candidate
...
for the 037_PERSONA_REJECT_RECORD_MODEL.md model area of PersonaOS.

model_role:
The 037_PERSONA_REJECT_RECORD_MODEL.md model set exists to define what must be stored, versioned,
