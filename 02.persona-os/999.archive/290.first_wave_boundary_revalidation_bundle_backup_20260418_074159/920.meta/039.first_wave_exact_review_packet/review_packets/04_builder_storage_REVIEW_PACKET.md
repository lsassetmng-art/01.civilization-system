...
domain_note:
Draft, validation, approval, publish persistence mapping and lineage rules.

primary_risk:
Collapsed status columns, missing lineage-safe publish mapping.
