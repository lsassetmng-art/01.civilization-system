...
domain_note:
Inbound event intake, validation, dedupe, apply handoff, and terminal feedback.

primary_risk:
Duplicate mutation, uncategorized reject family, hidden retry behavior.
