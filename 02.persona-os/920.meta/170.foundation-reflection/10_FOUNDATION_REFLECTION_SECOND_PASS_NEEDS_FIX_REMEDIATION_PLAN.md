# ============================================================
# PERSONA OS FOUNDATION REFLECTION SECOND PASS NEEDS-FIX REMEDIATION PLAN
# ============================================================
...
purpose:
Captures the remediation plan for files that did not pass
the initial structural verification of second-pass VisualRuntime patches.
...
- after fix -> rerun verification report and summary
...
Create or run a remediation one-block for the NEEDS_FIX files only,
then rerun:
...
Second-pass structural closure is blocked until all NEEDS_FIX files
are corrected and pass verification.
