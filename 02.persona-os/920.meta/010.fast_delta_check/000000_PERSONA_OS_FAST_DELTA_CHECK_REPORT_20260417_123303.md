# ============================================================
# PERSONA OS FAST DELTA CHECK REPORT
# ============================================================

status: completed
system: PersonaOS
generated_at: 20260417_123303

summary:
- target_file_count: 310
- fast_delta_missing_count: 3320
- root_relative_missing_count: 1172
- relative_missing_count: 0
- same_dir_file_missing_count: 2148

fast_mode_rules:
- no integrated rebuild
- no full-tree scan
- no index rebuild
- checked only files referenced by latest missing report and changed-file list
