...
- state_apply is the canonical truth mutation boundary
- only PersonaOS-approved transitions may mutate canonical mutable truth
- no external OS may bypass state_apply

canonical_write_scope:
- personas
- persona_state
- growth_core_state where applicable
- memory_state where applicable
- append-only logs and audit traces that belong to PersonaOS canonical control

forbidden_write_scope:
- external direct mutation
- mirror table mutation treated as truth mutation
- cache or derived state treated as truth mutation
