...
create index if not exists idx_scenario_version_master_id
  on scenario.scenario_version(scenario_master_id);

create index if not exists idx_scenario_chapter_version_id
  on scenario.scenario_chapter(scenario_version_id);

create index if not exists idx_scenario_scene_version_id
  on scenario.scenario_scene(scenario_version_id);

create index if not exists idx_scenario_scene_chapter_id
  on scenario.scenario_scene(scenario_chapter_id);

create index if not exists idx_scenario_choice_scene_id
  on scenario.scenario_choice(scenario_scene_id);

create index if not exists idx_scenario_branch_rule_scene_id
  on scenario.scenario_branch_rule(scenario_scene_id);

create index if not exists idx_scenario_trigger_scene_id
  on scenario.scenario_trigger(scenario_scene_id);

create index if not exists idx_scenario_character_binding_scene_id
  on scenario.scenario_character_binding(scenario_scene_id);

create index if not exists idx_scenario_event_binding_scene_id
  on scenario.scenario_event_binding(scenario_scene_id);

create index if not exists idx_scenario_asset_binding_scene_id
  on scenario.scenario_asset_binding(scenario_scene_id);

create index if not exists idx_scenario_progress_rule_version_id
  on scenario.scenario_progress_rule(scenario_version_id);
