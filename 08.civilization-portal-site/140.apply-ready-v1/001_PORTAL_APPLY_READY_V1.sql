...
-- source: 120019_PORTAL_SCHEMA_DDL_DRAFT.sql
...
create index if not exists idx_portal_copy_text_copy_key on portal.copy_text(copy_key);
create index if not exists idx_portal_copy_text_page_code on portal.copy_text(page_code);
create index if not exists idx_portal_copy_text_section_code on portal.copy_text(section_code);
create index if not exists idx_portal_nav_node_parent_nav_node_id on portal.nav_node(parent_nav_node_id);
create index if not exists idx_portal_nav_node_node_type on portal.nav_node(node_type);
create index if not exists idx_portal_nav_node_sort_order on portal.nav_node(sort_order);
create index if not exists idx_portal_nav_node_target_nav_node_id on portal.nav_node_target(nav_node_id);
create index if not exists idx_portal_helpdesk_entry_sort_order on portal.helpdesk_entry(sort_order);
create index if not exists idx_portal_page_section_page_code on portal.page_section(page_code);
create index if not exists idx_portal_page_section_sort_order on portal.page_section(sort_order);
create index if not exists idx_portal_page_section_item_page_section_id on portal.page_section_item(page_section_id);
create index if not exists idx_portal_page_section_item_ref_nav_node_id on portal.page_section_item(ref_nav_node_id);
create index if not exists idx_portal_page_section_item_ref_helpdesk_entry_id on portal.page_section_item(ref_helpdesk_entry_id);
