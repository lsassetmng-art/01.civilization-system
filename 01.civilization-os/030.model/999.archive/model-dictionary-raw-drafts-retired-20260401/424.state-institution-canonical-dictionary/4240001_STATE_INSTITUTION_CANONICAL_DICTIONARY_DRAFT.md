# ============================================================
# STATE INSTITUTION CANONICAL DICTIONARY DRAFT
# ============================================================

status: canonical_draft
prepared_by: Zero
scope: civilization_state_institutions

# ============================================================
# RULE
# ============================================================

- This file defines state-level institutions and quasi-state governing bodies.
- Company entities are out of scope.
- Facility-level instances are out of scope unless they are institutionally primary.
- Later refinement may split:
  ...
  - public_infrastructure_authority
