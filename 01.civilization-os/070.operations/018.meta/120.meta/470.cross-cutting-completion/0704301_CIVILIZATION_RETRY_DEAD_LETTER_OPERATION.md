# ============================================================
# CIVILIZATION RETRY DEAD LETTER OPERATION
# ============================================================
...
purpose:
Define operational handling for retry and dead-letter governance.
...
success_condition:
- retry or dead-letter lifecycle handled explicitly
