...
purpose:
- Canonical implementation/index entry for GameOS implementation-start materials
- Holds implementation-ready package, phase order, and acceptance set
...
rules:
- Implementation-layer files must stay aligned with model, flow, and interface contracts
- Index and overview must remain present at this folder level
