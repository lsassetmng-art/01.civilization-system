...
Model files must use the following format:
...
## Folder Number
Folder number identifies the canonical root layer.
...
For model files, the root folder is typically 030.
...
Serial numbers must be unique within the final numbering scope.
