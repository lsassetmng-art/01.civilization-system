...
## COMMON OS ROLE
This directory defines shared flows and operational UI patterns used across OSs and ERP surfaces.

## COMMON OS RESPONSIBILITIES
- shared user interaction flows\n- offline queue flow patterns\n- sync retry/conflict presentation flows\n- cross-app shared navigation flow patterns

## COMMON OS NON-GOALS
- domain transaction execution canon\n- domain-specific posting rules\n- domain-specific approval authority logic
