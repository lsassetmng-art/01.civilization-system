...
## COMMON OS ROLE
This directory defines the highest-level governance and invariant rules for CommonOS.

## COMMON OS RESPONSIBILITIES
- root-level shared governance\n- cross-OS shared foundation principles\n- non-domain ownership boundaries\n- formal interpretation rules for shared UI and app_common
