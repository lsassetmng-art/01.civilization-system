...
## COMMON OS ROLE
This directory defines shared integration ledgers and cross-domain coordination references for CommonOS.

## COMMON OS RESPONSIBILITIES
- shared component ledgers\n- shared applicability ledgers\n- ERP applicability references\n- common adoption references for other OSs/apps

## COMMON OS NON-GOALS
- domain-owned integration event canon\n- business transaction ownership\n- credential or secret exchange storage
