...
## COMMON OS ROLE
This directory defines policy-level rules for CommonOS shared assets and their safe use.

## COMMON OS RESPONSIBILITIES
- shared use policy\n- metadata storage policy\n- presentation boundary policy\n- offline/sync behavior policy

## COMMON OS NON-GOALS
- domain-specific legal canon\n- pricing engine internals\n- secret management internals
